...
export function Navigation({ className }: NavigationProps) {
  ...
  // Observe sections to set aria-current on matching nav item
  useEffect(() => {
  ...
  // Keyboard: close on Escape and trap focus when menu open
  useEffect(() => {
  ...
  const navItems = [
    { name: hu.landing.nav.home, id: 'hero' },
    { name: hu.landing.nav.features, id: 'features' },
  ...
  return (
    <header role="banner">
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Button
                variant="ghost"
                className={cn(
                  "transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500",
                  isScrolled
                    ? "text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-lg">
            ...
            <div className="pt-4 pb-2 border-t border-gray-200 dark:border-gray-700">
              <div className="flex flex-col space-y-2">
                <Button
                  variant="ghost"
                  className="justify-start text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
                  onClick={() => (window.location.href = '/login')}
                >
                  {hu.common.buttons.signIn}
                </Button>
      ...
      {/* Live region for menu state changes */}
