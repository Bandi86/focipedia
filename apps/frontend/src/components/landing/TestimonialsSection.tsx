  ...
  const testimonials = [
    {
      ...
      role: "Fradi szurkoló",
      avatar: "KP",
      content: "A Focipedia teljesen megváltoztatta, ahogy a futballt követem. Fantasztikus közösség és mindig naprakész információk!",
      rating: 5
    },
    {
      name: "Nagy Anna",
      role: "Újpest drukkere",
      avatar: "NA",
      content: "Végre egy platform, ahol kulturáltan lehet beszélgetni a futballról. Az élő kommentelés a meccsek alatt fantasztikus!",
      rating: 5
    },
    {
      name: "Szabó Gábor",
      role: "Vidi szurkoló",
      avatar: "SG",
      content: "A statisztikák és elemzések segítségével sokkal jobban megértem a játékot. Profi szintű tartalom!",
      rating: 5
    },
    {
      name: "Tóth Eszter",
      role: "Honvéd drukkere",
      avatar: "TE",
      content: "Imádom, hogy mobilon is tökéletesen működik. Bárhol vagyok, mindig kapcsolatban maradhatok a közösséggel.",
      rating: 4
    },
    {
      name: "Horváth Zoltán",
      role: "Paks szurkoló",
      avatar: "HZ",
      content: "A személyre szabott tartalom miatt mindig érdekes dolgokat találok. Az algoritmus tényleg megtanulja, mi érdekel.",
      rating: 5
    },
    {
      name: "Kiss Márta",
      role: "Debrecen drukkere",
      avatar: "KM",
      content: "A közösség tagjai segítőkészek és barátságosak. Sok új barátot szereztem itt a futball szeretete által.",
      rating: 5
    }
  ];
